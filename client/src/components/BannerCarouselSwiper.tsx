...
export const BannerCarouselSwiper: React.FC<BannerCarouselSwiperProps> = ({
  ...
  const responsive = {
    desktop: { breakpoint: { max: 3000, min: 1280 }, items: 1, partialVisibilityGutter: 80 },
    tablet:  { breakpoint: { max: 1280, min: 768 },  items: 1, partialVisibilityGutter: 60 },
  ...
  return (
    <div style={{ position: 'relative', width: '100%', maxWidth: 1250, margin: '0 auto' }}>
      ...
      <style>{`
        .banner-carousel-container { overflow: visible; max-width: 1250px; margin: 0 auto; padding-inline: 20px; }
        ...
        .banner-carousel-container:hover .react-multiple-carousel__arrow {
          opacity: 1;
          visibility: visible;
        }
