            ...
            <div className="flex items-center justify-between">
              ...
              {store.whatsapp && (
                <button 
                  ...
                  className="bg-green-500 hover:bg-green-600 text-white px-4 py-2 rounded-full font-medium transition-colors flex items-center gap-2 relative z-20"
                  title="Perguntar no WhatsApp"
                  data-testid="whatsapp-story-button"
                >
