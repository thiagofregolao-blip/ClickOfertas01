            ...
            <div className="bg-white border-b">
              <div className="px-3 py-6">
                    ...
                    <div className="flex-shrink-0">
                      {store.logoUrl ? (
                        <img 
                          src={store.logoUrl} 
                          alt={store.name}
                          className="w-16 h-16 rounded-full object-cover shadow-xl ring-4 ring-white"
                        />
                      ) : (
                        <div 
                          className="w-16 h-16 rounded-full flex items-center justify-center text-white font-bold shadow-xl ring-4 ring-white"
                          style={{ backgroundColor: store.themeColor || '#E11D48' }}
                        >
                ...
                <div className="hidden md:flex md:items-center gap-6">
                  ...
                  {store.latitude && store.longitude && (
                    <div className="flex-shrink-0">
                      <div className="text-gray-700 text-sm font-bold mb-2 text-center">Ver no mapa</div>
        ...
        <div className={`${isStoriesView ? 'p-6' : 'p-6'}`}>
          ...
          {filteredProducts.length > 0 || virtualClones.length > 0 ? (
            params ? (
              ...
              <div className="grid gap-3 sm:gap-6 grid-cols-3 sm:grid-cols-3 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5">
