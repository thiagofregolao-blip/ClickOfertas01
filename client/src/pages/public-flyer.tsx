            ...
            <div className="relative aspect-[9/16] bg-black">
              ...
              <div className="absolute top-0 left-0 right-0">
                <div className="bg-black/15 backdrop-blur-sm pt-8 pb-3 px-3 flex items-center gap-3">
                  ...
                  <div className="flex-1">
                    <p className="text-white font-light text-sm" style={{textShadow: '0 0 8px rgba(255,255,255,0.8), 0 0 16px rgba(255,255,255,0.4), 0.5px 0.5px 0 rgba(0,0,0,0.8), -0.5px -0.5px 0 rgba(0,0,0,0.8), 0.5px -0.5px 0 rgba(0,0,0,0.8), -0.5px 0.5px 0 rgba(0,0,0,0.8)'}}>{viewingStory.store.name}</p>
                    <p className="text-white/90 font-light text-xs" style={{textShadow: '0 0 6px rgba(255,255,255,0.6), 0.5px 0.5px 0 rgba(0,0,0,0.8), -0.5px -0.5px 0 rgba(0,0,0,0.8), 0.5px -0.5px 0 rgba(0,0,0,0.8), -0.5px 0.5px 0 rgba(0,0,0,0.8)'}}>há {Math.round((Date.now() - new Date(viewingStory.createdAt).getTime()) / 3600000)}h</p>
                  </div>
                </div>
              </div>
