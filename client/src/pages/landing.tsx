  ...
  return (
    <div className="min-h-screen flex flex-col">
      ...
      <div className="flex-1 bg-gradient-to-br from-orange-400 via-orange-500 to-red-500 relative overflow-hidden">
        ...
        <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-80 lg:w-96 bg-white rounded-xl shadow-2xl p-6 lg:p-8 lg:translate-x-48">
