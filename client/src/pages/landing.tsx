                ...
                <div className="mt-8 px-6">
                  ...
                  <div className="flex justify-center items-center gap-6 flex-wrap px-2">
                    ...
                    <div className="group cursor-pointer">
                      <div className="w-16 h-16 rounded-full bg-white shadow-lg border-2 border-yellow-300/50 overflow-hidden transition-all duration-300 group-hover:scale-110 group-hover:shadow-xl group-hover:border-yellow-300">
                        <img 
                    ...
                    {/* Cell Shop */}
                    <div className="group cursor-pointer">
                      <div className="w-16 h-16 rounded-full bg-gradient-to-br from-blue-500 to-purple-600 shadow-lg border-2 border-yellow-300/50 overflow-hidden transition-all duration-300 group-hover:scale-110 group-hover:shadow-xl group-hover:border-yellow-300 flex items-center justify-center">
                    ...
                    {/* Atacado Store */}
                    <div className="group cursor-pointer">
                      <div className="w-16 h-16 rounded-full bg-gradient-to-br from-green-500 to-emerald-600 shadow-lg border-2 border-yellow-300/50 overflow-hidden transition-all duration-300 group-hover:scale-110 group-hover:shadow-xl group-hover:border-yellow-300 flex items-center justify-center">
                        <ShoppingBag className="w-6 h-6 text-white" />
                      </div>
