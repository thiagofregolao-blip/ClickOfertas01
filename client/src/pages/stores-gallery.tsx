        ...
        <div className="px-4 pb-3">
          {isMobile ? (
            ...
            <div className="relative">
              <div className="flex gap-3 overflow-x-auto pb-2 scrollbar-hide">
                {displayProducts.map((product) => (
                  <div key={product.id} className="flex-shrink-0 w-40 sm:w-44 md:w-48 h-64 sm:h-68">
                    <ProductCard
                      product={product}
            ...
            <div className="grid grid-cols-4 gap-4">
              ...
              {/* Preencher slots vazios se houver menos de 4 produtos */}
              {Array.from({ length: Math.max(0, 4 - displayProducts.length) }).map((_, index) => (
