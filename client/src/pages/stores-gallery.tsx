            ...
            <div className="flex-1 max-w-md">
              <div className="relative">
                ...
                <Input
                  ...
                  className="pl-10 pr-10 py-2 w-full bg-white/10 border-white/20 text-white placeholder-white/70 focus:bg-white/20 focus:border-white/40 backdrop-blur-sm"
                />
                {searchInput && (
                  <button
